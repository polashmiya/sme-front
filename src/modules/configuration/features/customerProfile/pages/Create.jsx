...
const CATEGORIES = ["Retail", "Wholesale", "Corporate"].map(c=>({label:c,value:c}));
...
export default function CustomerProfileCreate() {
  ...
  const fields = [
    ...
    { input: { name: "name", label: "Customer Name", placeholder: "Enter name" } },
  ...
  return (
    <CommonCreateLayout title="Create Customer" onSubmit={handleSubmit(onSubmit)} submitDisabled={isSubmitting} onCancel={() => reset()}>
