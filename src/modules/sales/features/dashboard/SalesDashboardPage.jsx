...
const salesTrend = months.map((m) => ({
  name: m,
  sales: Math.floor(Math.random() * 950000) + 150000,
}));
...
const topCustomers = Array.from({ length: 5 }).map((_, i) => ({
  name: `Customer ${i + 1}`,
  value: Math.floor(Math.random() * 400000) + 80000,
}));
...
export default function SalesDashboardPage() {
  ...
  return (
    <>
      <HeaderWithOutCard
        title={t("sales.dash.title", { defaultValue: "Sales Dashboard" })}
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          <ListCard
            title={t("sales.dash.lists.approvals")}
            items={[
              {
                id: "SO-1025",
                label: "SO-1025 - Customer X - ৳ 50,000",
                to: "/sales/order",
                status: "Pending",
              },
              {
                id: "SO-1024",
                label: "SO-1024 - Customer A - ৳ 32,000",
                to: "/sales/order",
                status: "Pending",
              },
            ]}
          />
          <ListCard
            title={t("sales.dash.lists.recentOrders")}
            items={[
              {
                id: "SO-1020",
                label: "SO-1020 - Customer A - Pending",
                to: "/sales/order",
                status: "Pending",
              },
              {
                id: "SO-1019",
                label: "SO-1019 - Customer B - Approved",
                to: "/sales/order",
                status: "Approved",
              },
              {
                id: "SO-1018",
                label: "SO-1018 - Customer C - Delivered",
                to: "/sales/order",
                status: "Delivered",
              },
            ]}
          />
          <ListCard
            title={t("sales.dash.lists.pendingDeliveries")}
            items={[
              {
                id: "SO-1015",
                label: "SO-1015 - ETA: 3 days",
                to: "/sales/delivery",
                status: "Pending",
              },
              {
                id: "SO-1014",
                label: "SO-1014 - ETA: 1 day",
                to: "/sales/delivery",
                status: "Pending",
              },
            ]}
          />
          <ListCard
            title={t("sales.dash.lists.recentReturns")}
            items={[
              {
                id: "RET-1",
                label: "Item C - 5 pcs",
          ...
          />
          <ListCard
            title={t("sales.dash.lists.overdueReceivables")}
            items={[
              {
                id: "CUS-B",
          ...
          />
          <ListCard
            title={t("sales.dash.lists.topHighlights")}
            items={[
              {
                id: "TOP-1",
                label: "Customer A - ৳ 2,00,000",
                to: "/sales/order",
                status: "Top",
              },
              {
                id: "TOP-2",
                label: "Item 1 - 1200 units",
                to: "/sales/order",
                status: "Fast",
              },
            ]}
