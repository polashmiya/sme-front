...
export default function FinancialReportLanding() {
  ...
  const tableColumns = [
    ...
    { title: t("account.report.totalRecords", "Total Records"), dataIndex: "totalRecords", textAlign: "right" },
  ];
  ...
  return (
    <CommonLandingLayout
      title={t("account.financial", "Financial Report")}
      headerButtons={[]}
      showSearch={true}
      onSearch={setSearch}
