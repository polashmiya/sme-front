      ...
      <div className="flex flex-col gap-4 w-full max-w-full sm:max-w-md mx-auto">
        {PURCHASE_SUB_MENUS.map((menu) => {
          ...
          return (
            <button
              key={menu.key}
              className=" flex items-center gap-4 px-4 py-5 rounded-2xl border border-gray-200 shadow-md bg-white hover:bg-primary/5 focus:outline-none transition-all"
              style={{ minWidth: 0 }}
